...
import styles from 'components/recommend/RecommendForm/RecommendForm.module.css';
import style from './ExerciseInputInfo.module.css';
...
const ExerciseInputInfo = ({
    ...
    return (
        <form className={`${formStyles.form} ${formStyles.common} ${style.container}`}>
            <h1 className={styles.title}>운동 추천</h1>

            {/* 목적 선택 필드 */}
            <div>
                <label className={`${labelStyles.label} ${style.label}`} htmlFor="purpose">
                    운동 목적
                </label>
                <select
